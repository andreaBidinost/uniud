...
class Sim {
	...
	/**
	 * Returns true if actual sim is active
	 * @return true if actual sim is active
	 */
	boolean isActive() {
		...
		return lastRechargeDate.after(oneYearPast);
	}
	...
	public String toString() {
		...
		builder.append(isOriginal?"Original":"Portabilized" );
	...
	void activatePromo(Promotions promo) {
		setActivePromo(promo);
		residual -= promo.getCost();
	}
